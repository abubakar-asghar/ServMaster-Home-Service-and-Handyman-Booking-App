...
// This is only demo copy of customer booking detail skeleton and in future it must be change

const ProviderBookingDetailsSkeleton = () => (
    ...
    <ScrollView showsVerticalScrollIndicator={false}>
      <View className="p-5 space-y-8">
        ...
        <View className="mt-4 items-center">
          <ShimmerPlaceholder
            style={{ width: "100%", borderRadius: 6, height: 1 }}
          />
        </View>
          ...
          <View className="bg-gray-100 rounded-2xl p-5 space-y-6">
            <View className="flex-row items-center gap-4">
              ...
              <View className="flex-1 space-y-3">
                <ShimmerPlaceholder
                  style={{ width: "70%", borderRadius: 6, height: 14 }}
                />
                <ShimmerPlaceholder
                  style={{
                    width: "50%",
...
export default ProviderBookingDetailsSkeleton;
